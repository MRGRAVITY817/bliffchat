(ns com.bliffchat
  (:require [com.biffweb :as biff]
            [com.bliffchat.email :as email]
            [com.bliffchat.app :as app]
            [com.bliffchat.home :as home]
            [com.bliffchat.worker :as worker]
            [com.bliffchat.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.bliffchat.test.*"))
...
(def initial-system
  {:biff/plugins #'plugins
   ...
   :com.bliffchat/chat-clients (atom #{})})
